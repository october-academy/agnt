...
AskUserQuestion: "누구와 했어? (ICP 특성: 나이, 직업, 상황)"
- 자유 입력

AskUserQuestion: "인터뷰 대상이 마지막으로 이 문제를 겪었을 때, 구체적으로 뭘 했어? 어떤 행동을 취했어?"
- 자유 입력

AskUserQuestion: "지금 어떻게 해결하고 있대?"
- 자유 입력

AskUserQuestion: "이 문제 때문에 실제로 돈을 쓰거나 시간을 투자한 적이 있대? 구체적으로 뭐에 얼마를?"
- 자유 입력

AskUserQuestion: "가장 놀라운 발견은?"
- 자유 입력

### 6-bis. 통합 보완 (Q2, Q3, Q4)

5개 질문 수집 후, Q2("고통점/행동"), Q3("현재 대안"), Q4("돈/시간 투자") 답변을 아래 조건으로 평가한다.
...
**부족한 항목이 1개 이상이면**, 단일 AskUserQuestion으로 통합 보완 1회:

AskUserQuestion: "다음 항목에서 구체적인 숫자나 행동이 부족해: {부족 항목 나열}. 보완해줄 수 있어?"
- 자유 입력

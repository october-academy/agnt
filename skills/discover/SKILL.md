...
- 이전 답변과 현재 단계에 맞춰 3-5개 선택지를 동적으로 생성
- 마지막 선택지는 항상 `기타 — 한 줄로 적을래`

E를 선택한 경우에만:
AskUserQuestion: "뭘 발견했는지 한 줄로 적어줘."
- 자유 입력

**A/B/C를 선택한 경우** — 구체화:

AskUserQuestion: "문제 성격은 어디에 가까워?"
- Q1과 앞선 답변을 바탕으로 문제 유형 후보 3-5개를 동적으로 생성
- 마지막 선택지는 항상 `기타 — 한 줄로 직접 적을래`

F를 선택한 경우에만:
AskUserQuestion: "문제를 한 줄로 적어줘."
- 자유 입력
...
- 문제 맥락에 맞는 세그먼트 후보 3-5개를 동적으로 생성
- 마지막 선택지는 항상 `기타 — 한 줄로 적을래`

F를 선택한 경우에만:
AskUserQuestion: "직업 + 상황까지 한 줄로 적어줘."
- 자유 입력
...
- 문제와 ICP 초안에 맞는 과금 형태 후보 3-5개를 동적으로 생성
- 예: 구독, 일회성, 서비스형, 무료+업셀, 아직 모름

AskUserQuestion: "가격대는 어디에 가까워?"
- ICP와 과금 형태에 맞는 가격대 후보 3-5개를 동적으로 생성
- 마지막 선택지로 `아직 모름` 허용

AskUserQuestion: "가설 문장을 자동으로 조합할까?"
- A) 응, 조합해
- B) 아니, 한 줄로 직접 적을래

B를 선택한 경우에만:
AskUserQuestion: "가설을 한 줄로 적어줘."
- 자유 입력
...
- 지금까지의 답변으로 드러난 취약 가정 후보 3-5개를 동적으로 생성
- 마지막 선택지는 항상 `기타 — 한 줄로 적을래`

E를 선택한 경우에만:
AskUserQuestion: "취약 가정을 한 줄로 적어줘."
- 자유 입력

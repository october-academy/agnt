...
| 용어 | 첫 도입 위치 | 도입 NPC |
|------|-------------|---------|
| proof | Day 0 Block 0 | 두리 |
| SPEC | Day 0 Block 0 (예고) → Day 1 Block 2 (본격) | 소리 |
| proof target | Day 0 Block 0 | 두리 |
| proof surface | Day 0 Block 0 | 두리 |
| proof loop | Day 0 Block 3 | 두리 |
| change set | Day 2 Block 2 | 바리 |
| delta | Day 4 Block 2 (예고) → Day 5 Block 0 (본격) | 한이 |
| verdict | Day 6 Block 2 | 은이 |
| customer proof | Day 2 Block 0 | 바리 |
| channel proof | Day 2 Block 0 | 바리 |

도입 예시:
```
두리: "네가 실제로 확인한 것 — 유저 반응, 클릭, 결제 의향 — 그게 여기선 'proof'야."
```

...
quests:
  ...
  - id: d3-ai-review
    ...
    title: "AI 반론 + 놓친 점 검토"
    xp: 30
transition: "Day 3 완료! 이제 response를 해석하고 change set을 다듬으러 갑니다."
---
...
- 변경 사항 (Change Set): v0 대비 바뀐 점
- 증거 요약 (Evidence Summary): customer/channel proof 요약
- 판단 기준 (Metric Gate): 다음에 볼 기준

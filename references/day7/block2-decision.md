...
- **Go 판정 시**: "Week 2에서는 AI가 코드를 함께 작성하고, 실제 프로덕트를 만들어 배포합니다. Day 8-10에서 SPEC 기반 MVP를 AI와 함께 만들고, Day 11부터 실제 유저에게 공개합니다."
- **Iterate 판정 시**: "Week 2에서는 더 날카로운 검증 도구와 AI 피드백 루프를 사용합니다. Day 8에서 새로운 검증 표면을 AI가 30분 안에 만들어줍니다. 지금까지의 데이터가 Week 2의 출발점이 됩니다."
- **Pivot 판정 시**: "Week 2에서는 새로운 방향의 빠른 검증을 AI와 함께 반복합니다. Day 8에서 새 방향의 SPEC v0부터 다시 시작하되, Week 1에서 배운 검증 기술이 속도를 2배로 만들어줍니다."
